...
<body style="background-color: whitesmoke">
    ...
    <div class="jumbotron">
        <div class="container">
            <h2 class="text-uppercase"><a href="dashboardAdmin.php" style="text-decoration: none; color: #cccc00">Cab Service Dashboard</a></h2>
            <h4>Welcome Admin <small><?php echo $_COOKIE['loginUser']; ?></small></h4>
            <div class="pull-right">
                <a style="padding: 10px;" href="vehical/vehicals.php"><i class="fa fa-car fa-fw"></i>Vehicles</a>
                <a style="padding: 10px;" href="user/users.php"><i class="fa fa-users fa-fw"></i>Users</a>
            </div>
        </div>
    </div>
    <div class="container">
